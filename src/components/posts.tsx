        ...
        { 
            props.데이터.map((data,idx)=>{
                ...
                <div className="feeds">
                    ...
                    <img 
                        src={"https://picsum.photos/600/800?random="+idx} 
                        width="100%"
                        />
                    </div>
                    ...
                    <div className="comments">
                        ...
                        <div id="like">좋아요 {props.데이터[idx].likeCount}개</div>
            
                        {data.content.length > 30 ? (
                            <div className="posting">
                            <span className="postingId">{data.userId}</span>
                            {전체내용 ? (
                                <span>{data.content}</span>
                            ) : (
                                <span>
                                <span>{data.content.substring(0, 30)} ...</span>
                                <span
                                    className="moreCtt"
                                    onClick={() => {
                                    전체내용수정(true);
                        ...
                        <div className="reply">
                            ...
                            >
                                ...
                                data[idx].comments.map((a, i) => {
                                return (
                                <div>
                                    <span>{a[i].유저id}</span>
                                    <span>{a[i].comment}</span>
                                </div>
                                );
                            })
                            )}
